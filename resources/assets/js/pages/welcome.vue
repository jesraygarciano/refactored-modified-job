<template>
  <div>
    <v-app light>
      ...
      <v-content>
        <section>
          <v-parallax :src="public_path + '/images/hero.jpeg'" height="600">
            <v-layout column align-center justify-center class="white--text">
              <img :src="public_path + '/images/logo_brand.png'" alt="Jobseed.js"> <!-- height="200" -->
              <h1 class="white--text mb-2 display-1 text-xs-center"></h1>
              <div class="subheading mb-3 text-xs-center">Powered by Nexseed</div>
        ...
        <section>
          <v-parallax :src="public_path + '/images/section.jpg'" height="380">
